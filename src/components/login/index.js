...
import {toggleLoginPageActive} from '../actions';


function LoginRoot() {
  const loginPageActive = useSelector(state => state.loginPageActive);
  ...
  return (
    ...
    <div className="row container shadow ps-0">
        ...
        <animated.div style={props} className="col-md-8 mb-4 row contentSection">
            {loginPageActive ? 
          ...
          <p className='mt-3 m-0 p-0'> <span>Sign up</span> <span style={{color:'lightgray'}}>/ Login</span></p>  
            ...
            <div className="col-md-6">
             ...
             <div className='mx-3 h-75 d-flex justify-content-center align-items-center'>
                <button className='btnDesign2' onClick={() => dispatch(toggleLoginPageActive())}>Sign up <TrendingFlatIcon/> </button> 
              </div>
            </div>
            </>
            :
            ...
            <div className="col-md-6 border-end">
             ...
             <div className='mx-3 h-75 d-flex justify-content-center align-items-center'>
                <button className='btnDesign2' onClick={() => dispatch(toggleLoginPageActive())}>Login<TrendingFlatIcon/> </button> 
              </div>
            </div>
            <div className="col-md-6">
             <RegisterPage />
